  ...
  return (
    <div className="w-full relative flex justify-center">
      ...
      <div className="absolute z-50 flex justify-end space-x-2 my-5 w-11/12 md:w-10/12">
        <button className="bg-white  text-custom-blue hover:text-white hover:bg-red-700 p-3 px-4">Contact Us</button>
        <button className="bg-white  text-custom-blue hover:text-white hover:bg-red-700 p-3 px-4">Translate</button>
      </div>
