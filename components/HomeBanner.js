  ...
  return (
    ...
    />
          ...
          <div className="relative overflow-hidden">
            ...
            <p className="text-white lg:text-2xl text-1xl z-50 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full">We are a counsel-led Indian legal advisory representing India and</p>
            <p className="text-white lg:text-2xl text-1xl z-50 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full my-10">people across the world in diverse areas of expertise.</p>
